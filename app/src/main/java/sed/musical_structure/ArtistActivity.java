    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NP.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent NPIntent = new Intent(ArtistActivity.this, NowActivity.class);
                startActivity(NPIntent);
            }
        });

        ImageView AR = (ImageView) findViewById(R.id.ALB);
        AR.setOnClickListener(new View.OnClickListener(){

            public void onClick(View view) {
                Intent ARIntent = new Intent(ArtistActivity.this, AlbumActivity.class);
        ...
        AL.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent ALIntent = new Intent(ArtistActivity.this, MainActivity.class);
        ...
        SO.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent SOIntent = new Intent(ArtistActivity.this, SongsActivity.class);
        ...
        PL.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent PLIntent = new Intent(ArtistActivity.this, PaymentActivity.class);
